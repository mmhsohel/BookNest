...
const DrawerContent = ({navigation}) => {
  ...
  const handleShare = async () => {
    try {
      const result = await Share.share({
        message:
          'Check out this amazing app! Download now: https://your-app-link.com',
      });
  ...
  const openWebsite = () => {
    Linking.openURL('https://your-website.com').catch(err =>
      console.error('Failed to open website:', err),
    );
  };

  const openFacebookPage = () => {
    Linking.openURL('https://facebook.com/yourpage').catch(err =>
