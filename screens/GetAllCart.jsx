    ...
    Alert.alert('Confirm Delete', 'Are you sure?', [
      ...
      },
      {
        ...
        onPress: async () => {
          try {
            // Optimistic update
            const response = await deleteCardAndCarousel('card', item._id);
...
const GetAllCart = ({navigation}) => {
  const [cards, setCards] = useState([]);
  const {books: cardBooks} = useBooks('card');
...
const styles = StyleSheet.create({
  ...
  updateButton: {
    ...
    borderRadius: 10,
    marginRight: 8,
    justifyContent: 'center', // vertically center inside button
  alignItems: 'center',     //
  },
 deleteButton: {
  ...
  justifyContent: 'center', // vertically center inside button
  alignItems: 'center',     // horizontally center inside button
},
